...
public:
    ...
    void setupUi(QDialog *WindowPer)
    {
        ...
        deleteAccBtn->setCursor(QCursor(Qt::PointingHandCursor));
        QIcon icon3;
        ...
        userSearchBtn->setGeometry(QRect(1340, 1020, 180, 48));
        userSearchBtn->setCursor(QCursor(Qt::BusyCursor));
        QIcon icon4;
        ...
        QIcon icon5;
        icon5.addFile(QString::fromUtf8(":/icon/icons8-plus-math-96.png"), QSize(), QIcon::Normal, QIcon::Off);
        addBtn->setIcon(icon5);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/icon/icons8-arrow-pointing-left-96.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/icon/icons8-save-96.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        followBtn->setCursor(QCursor(Qt::PointingHandCursor));
